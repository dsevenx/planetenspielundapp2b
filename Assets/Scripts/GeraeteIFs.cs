...
public class GeraeteIFs
{
	...
	{
		return mBreiteDisplay == 1624 && mHoeheDisplay == 750 || mBreiteDisplay == 2208 && mHoeheDisplay == 1242 || mBreiteDisplay == 2436 && mHoeheDisplay == 1125 || mBreiteDisplay == 2688 && mHoeheDisplay == 1242 || mBreiteDisplay == 1920 && mHoeheDisplay == 1080;
	}

	public  bool istIPHONE_small (int mBreiteDisplay, int mHoeheDisplay)
	{
		return mBreiteDisplay == 1334 && mHoeheDisplay == 750 || mBreiteDisplay == 1792 && mHoeheDisplay == 828
